/* Generated from src/config.mak (yes/no -> 1/0) for the devkitPPC build */
...
#define HAVE_RUNTIME_CPUDETECT 0
...
#define CONFIG_RESAMPLE_AUDIOPHILE_KIDDY_MODE 0
#define CONFIG_RESAMPLE_HP 0
...
#define CONFIG_TI_C54X 0
#define CONFIG_TI_C55X 0
#define CONFIG_TI_C6X 0
...
#define FFMPEG_CONFIGURATION "devkitPPC"
