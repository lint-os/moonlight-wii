HAVE_PAIRED = no
# Hand-maintained config.mak for building libavutil/libavcodec/libswscale
# with devkitPPC (Wii/GEKKO). Derived from the WiiMC-SSLC mplayer build
# (see WiiMC-SSLC/backup_ffmpeg/config.mak); mplayer-only bits removed.
#
# Requires DEVKITPRO and DEVKITPPC in the environment.
...
EXTRA_INC = -I../include -I$(DEVKITPRO)/portlibs/ppc/include -I$(DEVKITPRO)/libogc/include -I$(DEVKITPRO)/portlibs/ppc/include/freetype2 -I$(DEVKITPRO)/libogc/include/ogc/machine
WIIFLAGS =-DGEKKO -mrvl -mcpu=750 -meabi -msdata -mmultiple-frename-registers

CFLAGS   = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls -Wmissing-prototypes -Wdisabled-optimization -Wno-pointer-sign -Wno-error=incompatible-pointer-types -Wdeclaration-after-statement -std=gnu99  -O3 -mcpu=750 -meabi -mrvl -msdata -mmultiple -pipe -g -ffast-math -frename-registers -DHAVE_AV_CONFIG_H -DGEKKO -DHW_RVL -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE $(EXTRA_INC)
CXXFLAGS = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls  -O3 -mcpu=750 -meabi -mrvl -msdata -mmultiple -pipe -g -ffast-math -frename-registers -DHAVE_AV_CONFIG_H -DGEKKO -DHW_RVL -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS $(EXTRA_INC)
...
HOSTCC     = $(HOST_CC)
HOSTCFLAGS = -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -O3 -I. -I.. -I../include
HOSTLIBS   = -lm
AS_O       = -o $@
CC_O       = -o $@
...
# Platform feature probes (devkitPPC / newlib / libogc)
HAVE_MMX = no
HAVE_MMX2 = no
HAVE_AVX = no
HAVE_AMD3DNOW = no
...
HAVE_VIRTUALALLOC = no
HAVE_FAST_CLZ = yes
HAVE_DCBZL = no
HAVE_BIGENDIAN = yes
HAVE_FAST_UNALIGNED = yes
HAVE_RUNTIME_CPUDETECT = no
ARCH_X86_32 = no
ARCH_X86_64 = no
CONFIG_DECODERS = yes
CONFIG_FASTDIV = yes
...
CONFIG_RESAMPLE_AUDIOPHILE_KIDDY_MODE = no
CONFIG_RESAMPLE_HP = no
CONFIG_RUNTIME_CPUDETECT = no
CONFIG_SAFE_BITSTREAM_READER = no
CONFIG_SMALL = no
...
HAVE_LOG2 = yes
HAVE_LOG2F = yes
HAVE_SYMVER_ASM_LABEL = no
HAVE_SYMVER_GNU_ASM = no
HAVE_XMM_CLOBBERS = no
ARCH_AVR32_AP = no
CONFIG_H264CHROMA = no
CONFIG_H264QPEL = no
CONFIG_SRAM = no
CONFIG_THUMB = no
CONFIG_TI_C54X = no
